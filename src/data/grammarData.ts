...
export const grammarData: GrammarRule[] = [
  {
    "id": "pos-01",
    "unitId": 1,
    ...
    "examples": [
      {
        "en": "Rimi runs fast because she loves sports.",
        "bn": "রিমি দ্রুত দৌড়ায় কারণ সে খেলাধুলা ভালোবাসে।",
        "note": "Sentence containing Noun, Verb, Adverb, Conjunction, Pronoun"
      }
    ],
    "tips": "মনে রাখার কৌশল: বাক্যে শব্দের রূপ দেখে নয়, শব্দটি কী কাজ করছে তা দেখে Part of Speech নির্ণয় করতে হয়।",
    "commonMistakes": [
      {
        "incorrect": "Water is noun always.",
        "correct": "I water (verb) the plants daily / Drink clean water (noun).",
        "reasonBn": "একই শব্দ বাক্যের ব্যবহারের ওপর ভিত্তি করে ভিন্ন Part of Speech হতে পারে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "commonMistakes": [
      {
        "incorrect": "He is a very honesty boy.",
        "correct": "He is an honest (adjective) boy / He has honesty (noun).",
        "reasonBn": "Honesty একটি গুণের নাম (Noun), দোষ-গুণ বোঝাতে Adjective (honest) ব্যবহার করতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Kazi Nazrul Islam is our national poet.",
        "bn": "কাজী নজরুল ইসলাম আমাদের জাতীয় কবি।"
      },
      {
        "en": "We visited Cox's Bazar last December.",
        "bn": "আমরা গত ডিসেম্বরে কক্সবাজার গিয়েছিলাম।"
      }
    ],
    "tips": "বাক্যের শুরুতে, মাঝে বা শেষে যেখানেই থাকুক না কেন, Proper Noun-এর প্রথম অক্ষর সর্বদা Capital Letter হবে।",
    "commonMistakes": [
      {
        "incorrect": "we visited sylhet on friday.",
        "correct": "We visited Sylhet on Friday.",
        "reasonBn": "Sylhet এবং Friday নির্দিষ্ট স্থান ও দিনের নাম (Proper Noun), তাই বড় হাতের অক্ষরে লিখতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The boy plays in the field.",
        "bn": "ছেলেটি মাঠে খেলছে।",
        "note": "'Boy' এবং 'field' সাধারণ নাম।"
      },
      {
        "en": "Rivers flow into the sea.",
        "bn": "নদীগুলো সাগরে গিয়ে মেশে।"
      }
    ],
    "tips": "Boy, City, River হলো Common Noun; কিন্তু Rahim, Dhaka, Padma হলো Proper Noun!",
    "commonMistakes": [
      {
        "incorrect": "The Padma is a famous River.",
        "correct": "The Padma is a famous river.",
        "reasonBn": "River শব্দটি সাধারণ নাম (Common Noun), তাই বাক্যের মাঝে বড় হাতের অক্ষরে লেখা যাবে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "A swarm of bees flew towards the flower.",
        "bn": "একঝাঁক মৌমাছি ফুলের দিকে উড়ে গেল।"
      },
      {
        "en": "Our football team won the trophy.",
        "bn": "আমাদের ফুটবল দল ট্রফি জিতেছে।"
      }
    ],
    "tips": "প্রাণীর দল বোঝাতে আলাদা শব্দ: Flock of birds, Herd of cows, Swarm of bees, School of fish!",
    "commonMistakes": [
      {
        "incorrect": "A team of players are playing.",
        "correct": "A team of players is playing.",
        "reasonBn": "Collective Noun সাধারণত একবচন (Singular) হিসেবে বিবেচিত হয়, তাই 'is' বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Kindness makes the world beautiful.",
        "bn": "দয়াশীলতা পৃথিবীকে সুন্দর করে তোলে।"
      },
      {
        "en": "Her courage inspired everyone.",
        "bn": "তার সাহস সবাইকে অনুপ্রাণিত করেছিল।"
      }
    ],
    "tips": "Truth, beauty, happiness, bravery, freedom—এগুলো সবই Abstract Noun কারণ এদের হাত দিয়ে ধরা যায় না!",
    "commonMistakes": [
      {
        "incorrect": "He showed many kindnesses.",
        "correct": "He showed great kindness.",
        "reasonBn": "Abstract Noun সাধারণত Uncountable, তাই এর বহুবচন (plural) হয় না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Mita is in Class 5. She loves reading.",
        "bn": "মিতা পঞ্চম শ্রেণীতে পড়ে। সে বই পড়তে ভালোবাসে।"
      },
      {
        "en": "The cat is sleeping because it is tired.",
        "bn": "বিড়ালটি ঘুমাচ্ছে কারণ এটি ক্লান্ত।"
      }
    ],
    "tips": "ছেলেদের ক্ষেত্রে He/Him, মেয়েদের ক্ষেত্রে She/Her, এবং প্রাণী বা জড় বস্তুর ক্ষেত্রে It ব্যবহার করুন।",
    "commonMistakes": [
      {
        "incorrect": "Mita is smart. Mita reads well.",
        "correct": "Mita is smart. She reads well.",
        "reasonBn": "বারবার 'Mita' না লিখে দ্বিতীয় বাক্যে Pronoun 'She' ব্যবহার করা সুন্দর।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "সে আমাকে বাড়ির কাজে সাহায্য করেছিল।",
        "note": "He = Subject, me = Object"
      },
      {
        "en": "The teacher praised us.",
        "bn": "শিক্ষক আমাদের প্রশংসা করলেন।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Preposition 'to'-এর পরে Objective Pronoun 'me' বসবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "This is my umbrella. That one is yours.",
        "bn": "এটি আমার ছাতা। ওইটি তোমার।"
      },
      {
        "en": "The bag on the table is hers.",
        "bn": "টেবিলের ওপরের ব্যাগটি তার।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Mine'-এর পর সরাসরি Noun বসে না, 'My' বসে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "পাখিরা আকাশে ওড়ে।",
        "note": "Action Verb: fly"
      },
      {
        "en": "She is reading a novel.",
        "bn": "সে একটি উপন্যাস পড়ছে।",
        "note": "Helping Verb: is, Main Verb: reading"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Continuous টেন্সে Helping verb (is) ছাড়া শুধু '-ing' verb বসানো ভুল।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Jamal is a brave and honest boy.",
        "bn": "জামাল একজন সাহসী ও সৎ ছেলে।"
      },
      {
        "en": "I bought five red apples.",
        "bn": "আমি পাঁচটি লাল আপেল কিনেছিলাম।"
      }
    ],
    "tips": "Noun-কে 'কেমন?', 'কতগুলো?' বা 'কোনটি?' প্রশ্ন করলে যে উত্তর পাওয়া যায়, তাই Adjective।",
    "commonMistakes": [
      {
        "incorrect": "She wears a dress blue.",
        "correct": "She wears a blue dress.",
        "reasonBn": "ইংরেজিতে সাধারণত Noun-এর আগেই Adjective বসাতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The tortoise walked slowly.",
        "bn": "কচ্ছপটি ধীরে ধীরে হেঁটেছিল।"
      },
      {
        "en": "She answered all questions politely.",
        "bn": "সে ভদ্রভাবে সব প্রশ্নের উত্তর দিয়েছিল।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "কথা বলার ধরন (Verb-কে বিশেষিত করতে) Adjective 'fluent' নয়, Adverb 'fluently' ব্যবহার করতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "We will start our journey tomorrow.",
        "bn": "আমরা আগামীকাল আমাদের যাত্রা শুরু করব।",
        "note": "Adverb of time: tomorrow"
      },
      {
        "en": "Please come inside.",
        "bn": "দয়া করে ভেতরে আসুন।",
        "note": "Adverb of place: inside"
      }
    ],
    "tips": "When = কখন (Time), Where = কোথায় (Place)।",
    "commonMistakes": [
      {
        "incorrect": "I saw him yesterday in morning.",
        "correct": "I saw him yesterday morning / in the morning.",
        "reasonBn": "'In morning' ভুল, 'in the morning' বা শুধু 'yesterday morning' বলতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Mina is poor but honest.",
        "bn": "মিনা দরিদ্র কিন্তু সৎ।"
      },
      {
        "en": "Take an umbrella or you will get wet.",
        "bn": "একটি ছাতা নাও নতুবা তুমি ভিজে যাবে।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "correct": "Although he is rich, he is greedy.",
        "reasonBn": "'Although' থাকলে একই বাক্যে পুনরায় 'but' ব্যবহার করা ভুল।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "কী আনন্দ! আমরা ক্রিকেট ম্যাচে জিতেছি!"
      },
      {
        "en": "Alas! The poor kitten is hurt.",
        "bn": "হায়! বেচারা বিড়ালছানাটি আঘাত পেয়েছে।"
      }
    ],
    "tips": "আনন্দে Hurrah!, দুঃখে Alas!, প্রশংসায় Bravo!, এবং বিস্ময়ে Wow! ব্যবহার করা হয়।",
    "commonMistakes": [
      {
        "incorrect": "Hurrah we won.",
        "correct": "Hurrah! We won.",
        "reasonBn": "Interjection-এর পরে অবশ্যই Exclamation mark (!) দিতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "commonMistakes": [
      {
        "incorrect": "He go to school by bus.",
        "correct": "He goes to school by bus.",
        "reasonBn": "'He' হলো 3rd person singular, তাই verb 'go'-এর সাথে 'es' যোগ হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The teacher is explaining the lesson now.",
        "bn": "শিক্ষক এখন পাঠটি ব্যাখ্যা করছেন।"
      },
      {
        "en": "They are playing football in the field.",
        "bn": "তারা মাঠে ফুটবল খেলছে।"
      }
    ],
    "tips": "I-এর সাথে am; He/She/It-এর সাথে is; You/We/They-এর সাথে are বসে।",
    "commonMistakes": [
      {
        "incorrect": "Look, the baby crying.",
        "correct": "Look, the baby is crying.",
        "reasonBn": "Continuous টেন্সে helping verb 'is' অবশ্যই দিতে হবে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "আমি আমার বাড়ির কাজ শেষ করেছি।"
      },
      {
        "en": "She has visited the zoo today.",
        "bn": "সে আজ চিড়িয়াখানা পরিদর্শন করেছে।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Have'-এর পর Past Participle (eaten) বসে, Past form (ate) নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "We played badminton yesterday evening.",
        "bn": "আমরা গতকাল সন্ধ্যায় ব্যাডমিন্টন খেলেছিলাম।"
      },
      {
        "en": "Raju planted a mango sapling last week.",
        "bn": "রাজু গত সপ্তাহে একটি আমের চারা রোপণ করেছিল।"
      }
    ],
    "tips": "Yesterday, last night, last year, ago থাকলে সাধারণত Simple Past Tense হয়।",
    "commonMistakes": [
      {
        "incorrect": "He play football yesterday.",
        "correct": "He played football yesterday.",
        "reasonBn": "Yesterday অতীত সময় নির্দেশ করে, তাই played হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Mother made a delicious cake.",
        "bn": "মা একটি সুস্বাদু কেক তৈরি করেছিলেন।",
        "note": "make -> made"
      },
      {
        "en": "I saw an elephant at the safari park.",
        "bn": "আমি সাফারি পার্কে একটি হাতি দেখেছিলাম।",
        "note": "see -> saw"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Go'-এর Past form হলো 'went', 'goed' বলে কোনো শব্দ নেই।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "It was raining heavily when I woke up.",
        "bn": "যখন আমি ঘুম থেকে উঠেছিলাম তখন ভারী বৃষ্টি হচ্ছিল।"
      },
      {
        "en": "The children were drawing pictures at 4 PM.",
        "bn": "বাচ্চারা বিকেল ৪টায় ছবি আঁকছিল।"
      }
    ],
    "tips": "Singular Subject (I, he, she, it)-এর সাথে was; Plural Subject (we, you, they)-এর সাথে were বসে।",
    "commonMistakes": [
      {
        "incorrect": "They was playing yesterday.",
        "correct": "They were playing yesterday.",
        "reasonBn": "'They' বহুবচন, তাই 'were' ব্যবহার করতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The school will reopen next Sunday.",
        "bn": "বিদ্যালয়টি আগামী রবিবার পুনরায় খুলবে।"
      },
      {
        "en": "I will help you with your project.",
        "bn": "আমি তোমার প্রকল্পে সাহায্য করব।"
      }
    ],
    "tips": "Will-এর পরে সর্বদা Verb-এর মূল বা Base form (do, go, see) বসে। কোনো s/es বা -ing যোগ হয় না!",
    "commonMistakes": [
      {
        "incorrect": "He will goes to Cox's Bazar.",
        "correct": "He will go to Cox's Bazar.",
        "reasonBn": "'Will'-এর পরে Verb-এর base form 'go' হবে, 'goes' নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Look at the dark clouds! It is going to rain.",
        "bn": "কালো মেঘগুলোর দিকে তাকাও! বৃষ্টি হতে যাচ্ছে।"
      },
      {
        "en": "We are going to visit our grandparents tomorrow.",
        "bn": "আমরা আগামীকাল আমাদের দাদা-দাদিকে দেখতে যাচ্ছি।"
      }
    ],
    "tips": "তাত্ক্ষণিক সিদ্ধান্তের জন্য 'will', আর পূর্বনির্ধারিত পরিকল্পনার জন্য 'going to' সবচেয়ে মানানসই!",
    "commonMistakes": [
      {
        "incorrect": "I am going to buying a new pen.",
        "correct": "I am going to buy a new pen.",
        "reasonBn": "'Going to'-এর পর verb-এর base form (buy) বসে, -ing যোগ হয় না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "She always drinks milk in the morning.",
        "bn": "সে সর্বদা সকালে দুধ পান করে।",
        "note": "Always -> Present Simple"
      },
      {
        "en": "They met two days ago.",
        "bn": "তারা দুদিন আগে দেখা করেছিল।",
        "note": "Ago -> Past Simple"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Yesterday' থাকায় verb-টি Past form (saw) হতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "I do not like bitter gourd.",
        "bn": "আমি করলা পছন্দ করি না।"
      },
      {
    ...
    "commonMistakes": [
      {
        "incorrect": "He does not likes tea.",
        "correct": "He does not like tea.",
        "reasonBn": "'Does'-এর মধ্যে 'es' চলে আসায় মূল verb 'like'-এর সাথে আর 's' বসবে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "We did not go to school on Friday.",
        "bn": "আমরা শুক্রবারে স্কুলে যাইনি।"
      },
      {
        "en": "She did not eat the cold soup.",
        "bn": "সে ঠান্ডা স্যুপটি খায়নি।"
      }
    ],
    "tips": "Did not-এর পরে কখনোই Past form (went, ate) বসবে না, সর্বদা base form (go, eat) বসবে!",
    "commonMistakes": [
      {
        "incorrect": "He did not went to Sylhet.",
        "correct": "He did not go to Sylhet.",
        "reasonBn": "'Did not'-এর পর Past form 'went' নয়, Base form 'go' বসবে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "তুমি কি ইংরেজিতে কথা বলো?"
      },
      {
        "en": "Does he live in Chattogram?",
        "bn": "সে কি চট্টগ্রামে বাস করে?"
      }
    ],
    "tips": "He, She, It, বা একবচন নামের আগে Does বসে। I, We, You, They-এর আগে Do বসে।",
    "commonMistakes": [
      {
        "incorrect": "Does she speaks French?",
        "correct": "Does she speak French?",
        "reasonBn": "'Does' ব্যবহার করায় 'speak'-এর সাথে আর 's' হবে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Did you enjoy the magic show yesterday?",
        "bn": "তুমি কি গতকাল জাদুর খেলাটি উপভোগ করেছিলে?"
      },
      {
        "en": "Did father bring sweet mangoes?",
        "bn": "বাবা কি মিষ্টি আম এনেছিলেন?"
      }
    ],
    "tips": "Did থাকলে Verb কখনো Past tense হবে না (Did you came? ভুল -> Did you come? সঠিক)।",
    "commonMistakes": [
      {
        "incorrect": "Did you saw the tiger?",
        "correct": "Did you see the tiger?",
        "reasonBn": "'Did'-এর সাথে Verb-এর Present/base form 'see' বসবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Once upon a time, there lived an honest woodcutter.",
        "bn": "একদা এক সময়ে এক সৎ কাঠুরিয়া বাস করত।"
      },
      {
        "en": "While he was cutting wood, his axe slipped into deep water.",
        "bn": "যখন সে কাঠ কাটছিল, তখন তার কুড়ালটি গভীর জলে পড়ে গেল।"
      }
    ],
    "tips": "গল্পের শুরুতেই 'Once upon a time' থাকলে পরের বাক্যগুলো Past Tense-এ লিখতে হয়।",
    "commonMistakes": [
      {
        "incorrect": "Once upon a time, a fox is hungry.",
        "correct": "Once upon a time, a fox was hungry.",
        "reasonBn": "গল্পের শুরুতে অতীতের কথা বোঝাতে 'is' নয়, 'was' ব্যবহার করতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The bright stars / twinkle at night.",
        "bn": "উজ্জ্বল তারাগুলো রাতে মিটমিট করে।",
        "note": "Subject: The bright stars, Predicate: twinkle at night"
      },
      {
        "en": "Birds / build nests in trees.",
        "bn": "পাখিরা গাছে বাসা বাঁধে।"
      }
    ],
    "tips": "বাক্যের Verb-কে 'কে?' বা 'কী?' প্রশ্ন করলে Subject পাওয়া যায়। বাকি অংশটি Predicate!",
    "commonMistakes": [
      {
        "incorrect": "Under the big mango tree.",
        "correct": "The cow is resting under the big mango tree.",
        "reasonBn": "শুধু 'Under the big mango tree' কোনো পূর্ণ বাক্য নয়, কারণ এতে Subject ও Finite Verb নেই।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      ...
      },
      {
        ...
        "bn": "গাছপালা আমাদের অক্সিজেন ও ছায়া দেয়।"
      }
    ],
    "tips": "Assertive বাক্য দুই ধরনের হতে পারে: Affirmative (হ্যাঁ-বোধক) এবং Negative (না-বোধক)।",
    "commonMistakes": [
      {
        "incorrect": "I go to school?",
        "correct": "I go to school.",
        "reasonBn": "সাধারণ তথ্য প্রকাশ করলে শেষে প্রশ্নবোধক চিহ্ন নয়, Full stop (.) দিতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      ...
      {
        "en": "Can you swim across the pond?",
        "bn": "তুমি কি পুকুরে সাঁতার কাটতে পারো?"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "প্রশ্ন করার সময় Helping verb (Are) Subject-এর আগে নিয়ে আসতে হয়।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "তোমার প্রিয় বিষয় কী?"
      },
      {
        "en": "Where do you live?",
        "bn": "তুমি কোথায় বাস করো?"
      },
      {
        "en": "When does your train arrive?",
        "bn": "তোমার ট্রেন কখন পৌঁছাবে?"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Wh-word-এর পরপরই Auxiliary verb 'do' বসাতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Who broke the window glass?",
        "bn": "কে জানালার কাচ ভেঙেছে?"
      },
      {
        "en": "Why are you crying, little boy?",
        "bn": "তুমি কেন কাঁদছ, ছোট ছেলে?"
      },
      {
        "en": "How do you go to school?",
        "bn": "তুমি কীভাবে স্কুলে যাও?"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Wh-question-এ 'are' Subject (you)-এর আগে বসবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Always speak the truth.",
        "bn": "সর্বদা সত্য কথা বলবে।",
        "note": "Advice"
      },
      {
        "en": "Please give me a glass of clean water.",
        "bn": "দয়া করে আমাকে এক গ্লাস পরিষ্কার পানি দিন।",
        "note": "Request"
      },
      {
        "en": "Do not run in the sun.",
        "bn": "রোদে দৌড়াদৌড়ি করো না।",
        "note": "Order/Prohibition"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "correct": "Please open the door / Open the door, please.",
        "reasonBn": "অনুরোধমূলক বাক্যে সাধারণত 'You' না বলে সরাসরি 'Please' দিয়ে শুরু করা ভালো।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "What a beautiful garden this is!",
        "bn": "এটি কী চমৎকার একটি বাগান!"
      },
      {
        "en": "How sweetly the cuckoo sings!",
        "bn": "কোকিল কত মিষ্টি সুরে গান গায়!"
      }
    ],
    "tips": "Noun থাকলে 'What a/an', আর শুধু Adjective থাকলে 'How' দিয়ে বাক্য শুরু করতে হয়!",
    "commonMistakes": [
      {
        "incorrect": "How a lovely flower!",
        "correct": "What a lovely flower! / How lovely the flower is!",
        "reasonBn": "'Flower' Noun থাকায় 'What a lovely flower' হবে, 'How a' ভুল।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Affirmative: Man is mortal. -> Negative: Man is not immortal.",
        "bn": "মানুষ মরণশীল -> মানুষ অমর নয়।"
      },
      {
        "en": "Affirmative: Rahim is an honest boy. -> Negative: Rahim is not a dishonest boy.",
        "bn": "রহিম সৎ ছেলে -> রহিম অসৎ ছেলে নয়।"
      }
    ],
    "tips": "Always থাকলে 'Never' এবং Must থাকলে 'Cannot but' ব্যবহার করতে হয়!",
    "commonMistakes": [
      {
        "incorrect": "Man is mortal -> Man is not mortal.",
        "correct": "Man is mortal -> Man is not immortal.",
        "reasonBn": "সরাসরি 'not mortal' লিখলে অর্থ বদলে যায়! বিপরীত শব্দ ব্যবহার করে রূপান্তর করতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "There is a pond in front of our school.",
        "bn": "আমাদের বিদ্যালয়ের সামনে একটি পুকুর আছে।"
      },
      {
        "en": "There are sixty students in our classroom.",
        "bn": "আমাদের শ্রেণীকক্ষে ষাট জন শিক্ষার্থী রয়েছে।"
      }
    ],
    "tips": "Noun-টি একবচন হলে 'is/was', আর বহুবচন হলে 'are/were' বসবে!",
    "commonMistakes": [
      {
        "incorrect": "There is many trees in the park.",
        "correct": "There are many trees in the park.",
        "reasonBn": "'Many trees' বহুবচন, তাই 'There are' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "It is hot and humid today.",
        "bn": "আজ বেশ গরম ও ভ্যাপসা আবহাওয়া।"
      },
      {
        "en": "It is half past ten in the morning.",
        "bn": "এখন সকাল সাড়ে দশটা বাজে।"
      }
    ],
    "tips": "বৃষ্টি হচ্ছে বোঝাতে: 'It is raining', বাতাস বইছে: 'It is windy'!",
    "commonMistakes": [
      {
        "incorrect": "Today is raining.",
        "correct": "It is raining today.",
        "reasonBn": "আবহাওয়ার বর্ণনা দিতে 'It is raining' বলা শুদ্ধ।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "তুমি একজন ছাত্র, তাই না?"
      },
      {
        "en": "He cannot swim, can he?",
        "bn": "সে সাঁতার কাটতে পারে না, পারে কি?"
      }
    ],
    "tips": "মূল বাক্য হ্যাঁ-বোধক হলে Tag হবে না-বোধক, আর মূল বাক্য না-বোধক হলে Tag হবে হ্যাঁ-বোধক!",
    "commonMistakes": [
      {
        "incorrect": "He is happy, is he?",
        "correct": "He is happy, isn't he?",
        "reasonBn": "বাক্যটি Affirmative, তাই Tag-টি Negative (isn't he) হতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The bell rang and the students entered the class.",
        "bn": "ঘণ্টা বাজল এবং শিক্ষার্থীরা ক্লাসে প্রবেশ করল।"
      },
      {
        "en": "He worked hard, but he failed the test.",
        "bn": "সে কঠোর পরিশ্রম করেছিল, কিন্তু পরীক্ষায় ব্যর্থ হয়েছিল।"
      }
    ],
    "tips": "দুই অংশই আলাদা বাক্য হিসেবে সম্পূর্ণ অর্থ প্রকাশ করতে সক্ষম হতে হবে!",
    "commonMistakes": [
      {
        "incorrect": "He ran fast but he win the race.",
        "correct": "He ran fast and he won the race / He ran fast but he missed the bus.",
        "reasonBn": "'But' পরস্পর বিপরীত ভাব প্রকাশ করতে ব্যবহৃত হয়।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "আমি একটি বই এবং একটি কলম কিনেছিলাম।"
      },
      {
        "en": "A tiger is a fierce wild animal.",
        "bn": "বাঘ একটি হিংস্র বন্য প্রাণী।"
      }
    ],
    "tips": "চিঠি নয়, শব্দের উচ্চারণ (Sound) লক্ষ্য করুন! Consonant sound হলে 'a' বসবে।",
    "commonMistakes": [
      {
        "incorrect": "I have an car.",
        "correct": "I have a car.",
        "reasonBn": "'Car' শব্দটি 'ক' (consonant sound) দিয়ে শুরু, তাই 'a' বসবে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "প্রতিদিন একটি আপেল খেলে ডাক্তার দূরে থাকে।"
      },
      {
        "en": "She carries an umbrella on rainy days.",
        "bn": "বৃষ্টির দিনে সে একটি ছাতা বহন করে।"
      }
    ],
    "tips": "Apple, Egg, Inkpot, Orange, Umbrella—এদের শুরুতে Vowel sound থাকায় 'an' বসে।",
    "commonMistakes": [
      {
        "incorrect": "I saw a owl sitting on the branch.",
        "correct": "I saw an owl sitting on the branch.",
        "reasonBn": "'Owl' শুরু হয়েছে Vowel sound দিয়ে, তাই 'an owl' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Mr. Karim is an honest officer.",
        "bn": "জনাব করিম একজন সৎ কর্মকর্তা।",
        "note": "'honest' উচ্চারিত হয় 'অনেস্ট'"
      },
      {
        "en": "Dhaka University is a renowned university.",
        "bn": "ঢাকা বিশ্ববিদ্যালয় একটি বিখ্যাত বিশ্ববিদ্যালয়।",
        "note": "'university' উচ্চারিত হয় 'ইউনিভার্সিটি'"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Hour' শব্দে 'h' অনুচ্চারিত থাকে (vowel sound 'আ'), তাই 'an hour' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      ...
      {
        "en": "I lost the pen that my father gave me.",
        "bn": "বাবা আমাকে যে কলমটি দিয়েছিলেন আমি সেটি হারিয়ে ফেলেছি।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "সূর্য পৃথিবীতে একটিই, তাই এর পূর্বে অবশ্যই 'The' বসবে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "মাউন্ট এভারেস্ট বিশ্বের সর্বোচ্চ শৃঙ্গ।"
      },
      {
        "en": "Niloy can play the guitar very well.",
        "bn": "নিলয় গিটার খুব ভালো বাজাতে পারে।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Superlative degree (best)-এর আগে 'the' বাদ দেওয়া যায় না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "We play cricket every afternoon.",
        "bn": "আমরা প্রতিদিন বিকেলে ক্রিকেট খেলি।",
        "note": "NOT 'the cricket'"
      },
      {
        "en": "English is an international language.",
        "bn": "ইংরেজি একটি আন্তর্জাতিক ভাষা।",
        "note": "NOT 'The English is a language'"
      }
    ],
    "tips": "ভাষার নামের আগে The বসালে সেই জাতির মানুষকে বোঝায় (The English = ইংরেজ জাতি; English = ইংরেজি ভাষা)!",
    "commonMistakes": [
      {
        "incorrect": "I love to play the football.",
        "correct": "I love to play football.",
        "reasonBn": "যেকোনো খেলাধুলার নামের পূর্বে Article বসে না।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "গ্লাসে কিছু দুধ আছে।"
      },
      {
        "en": "There isn't any sugar left in the jar.",
        "bn": "বয়ামে কোনো চিনি অবশিষ্ট নেই।"
      },
      {
        "en": "Do you have any questions?",
        "bn": "তোমাদের কি কোনো প্রশ্ন আছে?"
      }
    ],
    "tips": "Would you like some tea? (ভদ্র অনুরোধে প্রশ্নেও 'some' হতে পারে!)",
    "commonMistakes": [
      {
        "incorrect": "I do not have some money.",
        "correct": "I do not have any money.",
        "reasonBn": "না-বোধক বাক্যে 'some'-এর পরিবর্তে 'any' ব্যবহার করতে হয়।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "গ্রন্থাগারে অনেক বই রয়েছে।"
      },
      {
        "en": "We do not have much time left.",
        "bn": "আমাদের কাছে আর বেশি সময় অবশিষ্ট নেই।"
      },
      {
        "en": "Add a little salt to the curry.",
        "bn": "তরকারিতে সামান্য লবণ দাও।"
      }
    ],
    "tips": "Books, pens, boys গণনা করা যায় (many/few); water, sugar, time গণনা করা যায় না (much/little)!",
    "commonMistakes": [
      {
        "incorrect": "He drank many water.",
        "correct": "He drank much water / a lot of water.",
        "reasonBn": "পানি (water) Uncountable noun, তাই 'many' বসবে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Honesty brings peace of mind.",
        "bn": "সততা মানসিক শান্তি বয়ে আনে।"
      },
      {
        "en": "Dr. Rahman is our family physician.",
        "bn": "ডা. রহমান আমাদের পারিবারিক চিকিৎসক।"
      }
    ],
    "tips": "ফুলস্টপ দিয়ে বাক্য শেষ হলে পরবর্তী বাক্যের প্রথম অক্ষর অবশ্যই Capital Letter হবে।",
    "commonMistakes": [
      {
        "incorrect": "I like mangoes We also have a tree",
        "correct": "I like mangoes. We also have a tree.",
        "reasonBn": "দুটি ভিন্ন বাক্যের মাঝে ফুলস্টপ না দিলে তা Run-on sentence হিসেবে গণ্য হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Where have you been all day?",
        "bn": "সারাদিন তুমি কোথায় ছিলে?"
      },
      {
        "en": "Stop! The bridge is broken ahead!",
        "bn": "থামো! সামনের সেতুটি ভাঙা!"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "প্রশ্নবোধক বাক্যের শেষে ফুলস্টপ নয়, Question mark (?) দিতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "I bought apples, bananas, oranges, and grapes.",
        "bn": "আমি আপেল, কলা, কমলা এবং আঙুর কিনেছিলাম।"
      },
      {
        "en": "Raju, please open the window.",
        "bn": "রাজু, দয়া করে জানালাটি খোলো।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "তালিকার শব্দগুলোর মাঝে কমা না দিলে অর্থ অস্পষ্ট হয়ে যায়।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "আমি উত্তরটি জানি না।",
        "note": "do not -> don't"
      },
      {
        "en": "It's a sunny day outside.",
        "bn": "বাইরে রৌদ্রোজ্জ্বল একটি দিন।",
        "note": "It is -> It's"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Its' হলো মালিকানা প্রকাশক (Possessive), এতে অ্যাপোস্ট্রফি হয় না। 'It's' মানে 'It is'।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "This is Nadia's schoolbag.",
        "bn": "এটি নাদিয়ার স্কুলব্যাগ।"
      },
      {
        "en": "They study in a girls' high school.",
        "bn": "তারা একটি বালিকা উচ্চ বিদ্যালয়ে পড়াশোনা করে।"
      }
    ],
    "tips": "Children, Men, Women বহুবচন হলেও s দিয়ে শেষ হয়নি, তাই এদের ক্ষেত্রে 's বসবে (Children's toys)!",
    "commonMistakes": [
      {
        "incorrect": "This is a boys's hostel.",
        "correct": "This is a boys' hostel.",
        "reasonBn": "যেহেতু 'boys' বহুবচনে s আছে, তাই শেষে শুধু অ্যাপোস্ট্রফি বসবে, বাড়তি s হবে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Teacher said, \"Always be polite to your elders.\"",
        "bn": "শিক্ষক বললেন, \"সর্বদা গুরুজনদের প্রতি বিনয়ী হবে।\""
      },
      {
        "en": "\"Can you help me?\" asked the traveler.",
        "bn": "\"আপনি কি আমাকে সাহায্য করতে পারেন?\" পথিকটি জিজ্ঞেস করলেন।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "কোটেশনের প্রথম অক্ষর Capital হবে এবং ফুলস্টপটি কোটেশনের ভেতরে থাকবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Every Friday in January, my brother and I play chess.",
        "bn": "জানুয়ারি মাসের প্রতি শুক্রবারে আমার ভাই ও আমি দাবা খেলি।"
      },
      {
        "en": "The Sundarbans is located in Khulna.",
        "bn": "সুন্দরবন খুলনায় অবস্থিত।"
      }
    ],
    "tips": "ইংরেজি সর্বনাম 'I' (আমি) বাক্যের যেখানেই থাকুক না কেন, সর্বদা Capital Letter হবে!",
    "commonMistakes": [
      {
        "incorrect": "my friend and i will visit sylhet in may.",
        "correct": "My friend and I will visit Sylhet in May.",
        "reasonBn": "My, I, Sylhet, এবং May—প্রতিটিই বড় হাতের অক্ষরে লিখতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "He is an eight-year-old boy.",
        "bn": "সে একজন আট বছর বয়সী বালক।"
      },
      {
        "en": "Mother made a mouth-watering meal.",
        "bn": "মা একটি লোভনীয় খাবার রান্না করেছিলেন।"
      }
    ],
    "tips": "Twenty-one থেকে ninety-nine পর্যন্ত সংখ্যাগুলো লিখতে মাঝে হাইফেন ব্যবহার করতে হয়!",
    "commonMistakes": [
      {
        "incorrect": "He is an eight years old boy.",
        "correct": "He is an eight-year-old boy / The boy is eight years old.",
        "reasonBn": "Noun-এর আগে Adjective হিসেবে বসলে হাইফেনসহ একবচন 'year' লিখতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      ...
      {
        "en": "The cat saw three birds on the tree.",
        "bn": "বিড়ালটি গাছের ওপর তিনটি পাখি দেখেছিল।"
      }
    ],
    "tips": "সরাসরি s যোগ হওয়া সবচেয়ে সাধারণ নিয়ম: tree -> trees, table -> tables, cow -> cows!",
    "commonMistakes": [
      {
        "incorrect": "I saw two car on the road.",
        "correct": "I saw two cars on the road.",
        "reasonBn": "সংখ্যা দুই (plural) হওয়ায় car-এর সাথে 's' যোগ হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Match -> Matches / Watch -> Watches",
        "bn": "ম্যাচ -> ম্যাচগুলো / ঘড়ি -> ঘড়িগুলো"
      },
      {
        "en": "Dish -> Dishes / Glass -> Glasses / Box -> Boxes",
        "bn": "প্লেট -> প্লেটগুলো / গ্লাস -> গ্লাসগুলো"
      }
    ],
    "tips": "মনে রাখার কৌশল: শিস-ধ্বনির পর শুধু s উচ্চারণ করা যায় না, তাই 'es' যোগ করতে হয়!",
    "commonMistakes": [
      {
        "incorrect": "two boxs of sweets.",
        "correct": "two boxes of sweets.",
        "reasonBn": "'Box'-এর শেষে x থাকায় plural করার সময় 'boxes' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "One baby, two babies.",
        "bn": "একটি শিশু, দুটি শিশু।",
        "note": "b + y -> babies"
      },
      {
        "en": "One boy, two boys.",
        "bn": "একটি ছেলে, দুটি ছেলে।",
        "note": "o + y -> boys"
      }
    ],
    ...
    "commonMistakes": [
      {
        "incorrect": "There are many citys in our country.",
        "correct": "There are many cities in our country.",
        "reasonBn": "'City'-এর 't' একটি consonant, তাই y উঠে 'ies' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Green leaves fell from the banyan tree.",
        "bn": "বটগাছ থেকে সবুজ পাতা ঝরে পড়ল।",
        "note": "leaf -> leaves"
      },
      {
        "en": "Keep sharp knives away from children.",
        "bn": "ধারালো ছুরিগুলো শিশুদের থেকে দূরে রাখুন।",
        "note": "knife -> knives"
      }
    ],
    ...
    "commonMistakes": [
      {
        "incorrect": "Dry leafs on the ground.",
        "correct": "Dry leaves on the ground.",
        "reasonBn": "'Leaf'-এর বহুবচন রূপ হলো 'leaves'।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        ...
        "bn": "প্রতিদিন সকালে দাঁত মাজবে।",
        "note": "tooth -> teeth"
      },
      {
        "en": "The children are playing happily.",
        "bn": "বাচ্চারা আনন্দের সাথে খেলছে।",
        "note": "child -> children"
      }
    ],
    ...
    "commonMistakes": [
      {
        "incorrect": "All the childrens are happy.",
        "correct": "All the children are happy.",
        "reasonBn": "'Children' নিজেই বহুবচন, তাই এর সাথে আর 's' যোগ করা ভুল।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "One sheep is grazing. Ten sheep are grazing.",
        "bn": "একটি ভেড়া ঘাস খাচ্ছে। দশটি ভেড়া ঘাস খাচ্ছে।"
      },
      {
        "en": "The hunter saw a herd of deer in the forest.",
        "bn": "শিকারি বনে একপাল হরিণ দেখেছিল।"
      }
    ],
    "tips": "Sheep, Deer, Fish—এদের সাথে সাধারণত 's' হয় না (তবে ভিন্ন প্রজাতির মাছ বোঝাতে fishes হতে পারে)!",
    "commonMistakes": [
      {
        "incorrect": "Three deers ran away.",
        "correct": "Three deer ran away.",
        "reasonBn": "'Deer'-এর বহুবচনও 'deer', deers নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "I ate two bananas.",
        "bn": "আমি দুটি কলা খেয়েছিলাম।",
        "note": "Countable"
      },
      {
    ...
    "commonMistakes": [
      {
        ...
        "correct": "Please give me a glass of water / some water.",
        "reasonBn": "পানি গোনা যায় না, তাই সরাসরি 'a water' বলা যায় না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The king and queen attended the ceremony.",
        "bn": "রাজা ও রানী অনুষ্ঠানে উপস্থিত ছিলেন।"
      },
      {
        "en": "My uncle and aunt live in London.",
        "bn": "আমার চাচা ও চাচি লন্ডনে বাস করেন।"
      }
    ],
    "tips": "Brother <-> Sister, Father <-> Mother, Son <-> Daughter, Husband <-> Wife!",
    "commonMistakes": [
      {
        "incorrect": "The actor played his role, and the actress played his role too.",
        "correct": "The actor played his role, and the actress played her role.",
        "reasonBn": "Feminine gender (actress)-এর Pronoun হবে 'her', 'his' নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The baby is smiling.",
        "bn": "শিশুটিকে দেখে ছেলে বা মেয়ে যে কেউই হতে পারে।",
        "note": "Common Gender"
      },
      {
        "en": "The wooden chair is broken.",
        "bn": "কাঠের চেয়ারটি ভাঙা।",
        "note": "Neuter Gender"
      }
    ],
    ...
    "commonMistakes": [
      {
        "incorrect": "The table fell and hurt his leg.",
        "correct": "The table fell and broke its leg.",
        "reasonBn": "টেবিল জড় বস্তু (Neuter Gender), তাই 'his' না হয়ে 'its' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Rooster (male) <-> Hen (female) -> Chick (baby)",
        "bn": "মোরগ <-> মুরগি -> মুরগির ছানা"
      },
      {
        "en": "Drake (male duck) <-> Duck (female) -> Duckling (baby)",
        "bn": "পাতিহাঁস (পুরুষ) <-> পাতিহাঁস (স্ত্রী) -> হাঁসের ছানা"
      },
      {
        "en": "Lion (male) <-> Lioness (female) -> Cub (baby)",
        "bn": "সিংহ <-> সিংহী -> সিংহের ছানা"
      }
    ],
    "tips": "Dog <-> Bitch -> Puppy; Cat <-> Queen -> Kitten; Horse <-> Mare -> Foal!",
    "commonMistakes": [
      {
        "incorrect": "A female lion is called a tiger.",
        "correct": "A female lion is called a lioness.",
        "reasonBn": "সিংহের স্ত্রীলিঙ্গ হলো Lioness।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Tall (Positive) -> Taller (Comparative) -> Tallest (Superlative)",
        "bn": "লম্বা -> অধিকতর লম্বা -> সবচেয়ে লম্বা"
      },
      {
        "en": "Rimi is tall. Jamal is taller than Rimi. Kamal is the tallest boy.",
        "bn": "রিমি লম্বা। জামাল রিমির চেয়ে লম্বা। কামাল সবার চেয়ে লম্বা।"
      }
    ],
    "tips": "একজনের বর্ণনা = Positive; দুজনের তুলনা = Comparative; সবার মধ্যে সেরা = Superlative!",
    "commonMistakes": [
      {
        "incorrect": "He is tallest boy than Kamal.",
        "correct": "He is taller than Kamal.",
        "reasonBn": "দুজনের তুলনায় Comparative form (taller) বসবে, Superlative নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Shuvo is as tall as his father.",
        "bn": "শুভ তার বাবার মতোই লম্বা।"
      },
      {
        "en": "She runs as fast as the wind.",
        "bn": "সে বাতাসের মতো দ্রুত দৌড়ায়।"
      }
    ],
    "tips": "As ... As-এর মাঝখানে সর্বদা Adjective-এর মূল Positive রূপ (tall, fast) বসে, comparative বা superlative নয়!",
    "commonMistakes": [
      {
        "incorrect": "He is as taller as his brother.",
        "correct": "He is as tall as his brother.",
        "reasonBn": "'as ... as'-এর মাঝে Comparative (taller) বসে না, Positive (tall) বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "An aeroplane is faster than a train.",
        "bn": "উড়োজাহাজ ট্রেনের চেয়ে দ্রুতগতিসম্পন্ন।"
      },
      {
        "en": "The Padma is wider than the Buriganga.",
        "bn": "পদ্মা বুড়িগঙ্গার চেয়ে প্রশস্ত।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "ছোট শব্দের ক্ষেত্রে 'more tall' হয় না, 'taller' হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The blue whale is the largest animal on Earth.",
        "bn": "নীল তিমি পৃথিবীর বৃহত্তম প্রাণী।"
      },
      {
        "en": "Today is the coldest day of the winter.",
        "bn": "আজ শীতের সবচেয়ে শীতলতম দিন।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Superlative degree-র পূর্বে অবশ্যই 'the' বসাতে হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Gold is more expensive than silver.",
        "bn": "স্বর্ণ রূপার চেয়ে বেশি মূল্যবান।"
      },
      {
        "en": "The peacock is the most beautiful bird.",
        "bn": "ময়ূর সবচেয়ে সুন্দর পাখি।"
      }
    ],
    "tips": "Beautiful, intelligent, interesting, difficult, dangerous—এদের আগে more/most বসে!",
    "commonMistakes": [
      {
        "incorrect": "This flower is beautifuller than that one.",
        "correct": "This flower is more beautiful than that one.",
        "reasonBn": "'Beautiful' একটি বড় শব্দ, তাই 'more beautiful' হবে, beautifuller নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Your drawing is good, but his drawing is better.",
        "bn": "তোমার আঁকা ভালো, কিন্তু তার আঁকা আরও ভালো।"
      },
      {
        "en": "Prevention is better than cure.",
        "bn": "প্রতিকারের চেয়ে প্রতিরোধই উত্তম।"
      },
      {
        "en": "That was the worst storm of the century.",
        "bn": "ওটি ছিল শতাব্দীর সবচেয়ে ভয়াবহ ঝড়।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Double comparative ('more better') ভুল, শুধু 'better' বলতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "I can ride a bicycle without support.",
        "bn": "আমি সাহায্য ছাড়াই সাইকেল চালাতে পারি।"
      },
      {
        "en": "Birds can fly, but penguins cannot.",
        "bn": "পাখিরা উড়তে পারে, কিন্তু পেঙ্গুইনরা পারে না।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "correct": "He can swim.",
        "reasonBn": "Modal verb 'can'-এর পর সরাসরি base verb বসে, 'to' বসে না।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "আপনি কি দয়া করে লবণটা এগিয়ে দেবেন?"
      },
      {
        "en": "Would you mind closing the window?",
        "bn": "আপনি কি দয়া করে জানালাটি বন্ধ করবেন?"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Would you mind'-এর পর Verb-এর সাথে '-ing' বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "May I come in, Sir?",
        "bn": "স্যার, আমি কি ভেতরে আসতে পারি?"
      },
      {
        "en": "May you live long and prosper!",
        "bn": "তুমি দীর্ঘজীবী ও সমৃদ্ধ হও!"
      }
    ],
    "tips": "ক্লাসরুমে শিক্ষকের অনুমতি চাইতে সর্বদা 'May I come in' বলতে হয়, 'Can I' নয়!",
    "commonMistakes": [
      {
        "incorrect": "Can I come in, teacher? (in formal class)",
        "correct": "May I come in, teacher?",
        "reasonBn": "শ্রেণীকক্ষে শিক্ষকের প্রতি আনুষ্ঠানিক সম্মান দেখাতে 'May' সবচেয়ে মার্জিত।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "খাওয়ার আগে তোমার হাত ধোয়া উচিত।"
      },
      {
        "en": "We should respect our parents and teachers.",
        "bn": "আমাদের পিতামাতা ও শিক্ষকদের সম্মান করা উচিত।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Should'-এর পরে 'to' বসে না, সরাসরি base verb বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Students must obey school rules.",
        "bn": "শিক্ষার্থীদের অবশ্যই স্কুলের নিয়মকানুন মানতে হবে।"
      },
      {
        "en": "You must stop when the traffic light turns red.",
        "bn": "ট্রাফিক বাতি লাল হলে তোমাকে অবশ্যই থামতে হবে।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "'Must'-এর পরে কোনো 'to' বসে না।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Would you like a cup of warm tea?",
        "bn": "আপনি কি এক কাপ গরম চা পছন্দ করবেন?"
      },
      {
        "en": "Would you like to play cricket with us?",
        "bn": "তুমি কি আমাদের সাথে ক্রিকেট খেলতে চাও?"
      }
    ],
    "tips": "উত্তর দেওয়ার ভদ্র নিয়ম: 'Yes, please' (গ্রহণ করলে) বা 'No, thank you' (না চাইলে)।",
    "commonMistakes": [
      {
        "incorrect": "Do you want tea? (to a formal guest)",
        "correct": "Would you like some tea?",
        "reasonBn": "মেহমানকে আপ্যায়নের সময় 'Do you want' না বলে 'Would you like' বলা অনেক বেশি ভদ্র।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Let's clean our classroom together.",
        "bn": "চলো আমরা একসাথে আমাদের শ্রেণীকক্ষ পরিষ্কার করি।"
      },
      {
        "en": "It is evening; let's go for a walk by the river.",
        "bn": "এখন সন্ধ্যা হয়েছে; চলো নদীর পাড়ে একটু হেঁটে আসি।"
      }
    ],
    "tips": "Let's-এর পর সর্বদা Verb-এর Base form বসে (Let's play, Let's go)!",
    "commonMistakes": [
      {
        "incorrect": "Let's going home.",
        "correct": "Let's go home.",
        "reasonBn": "'Let's'-এর পর verb-এর সাথে -ing যোগ হয় না, base form 'go' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "\"Could I borrow your eraser?\" -> \"Sure, here you go!\"",
        "bn": "\"আমি কি তোমার ইরেজারটি ধার নিতে পারি?\" -> \"অবশ্যই, এই নাও!\""
      },
      {
        "en": "\"Can you come right now?\" -> \"I am sorry, I am doing my homework.\"",
        "bn": "\"তুমি কি এখন আসতে পারবে?\" -> \"দুঃখিত, আমি আমার বাড়ির কাজ করছি।\""
      }
    ],
    "tips": "না বলতে সরাসরি 'No' না বলে 'I'm sorry, I can't' বলা ভদ্র শিষ্টাচার।",
    "commonMistakes": [
      {
        "incorrect": "Give me that. No I won't.",
        "correct": "Could you give me that? - I'm sorry, I need it right now.",
        "reasonBn": "ভদ্র কথোপকথন সামাজিক সম্পর্কের উন্নতি ঘটায়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Our school assembly starts at 9:00 AM.",
        "bn": "আমাদের স্কুলের প্রাত্যহিক সমাবেশ সকাল ৯টায় শুরু হয়।"
      },
      {
        "en": "Owls hunt for prey at night.",
    ...
    "commonMistakes": [
      {
        "incorrect": "He arrived in 4 PM.",
        "correct": "He arrived at 4 PM.",
        "reasonBn": "নির্দিষ্ট ঘড়ির সময়ের পূর্বে 'in' নয়, 'at' বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Our Independence Day is on 26th March.",
        "bn": "আমাদের স্বাধীনতা দিবস ২৬শে মার্চ।"
      },
      {
        "en": "We do not have classes on Friday.",
        "bn": "শুক্রবারে আমাদের কোনো ক্লাস থাকে না।"
      }
    ],
    "tips": "দিন বা তারিখ পেলেই চোখ বন্ধ করে 'On' বসাবেন!",
    "commonMistakes": [
      {
        "incorrect": "I was born in 16th December.",
        "correct": "I was born on 16th December.",
  ...
  },
  {
    ...
    "examples": [
      {
        "en": "Bangladesh became independent in 1971.",
        "bn": "বাংলাদেশ ১৯৭১ সালে স্বাধীন হয়েছিল।"
      },
      {
        "en": "Flowers bloom vibrantly in spring.",
        "bn": "বসন্তে প্রাণবন্তভাবে ফুল ফোটে।"
      }
    ],
    "tips": "ঘড়ির সময় -> At; দিন ও তারিখ -> On; মাস, বছর ও ঋতু -> In!",
    "commonMistakes": [
      {
        "incorrect": "Our final exam will start on November.",
        "correct": "Our final exam will start in November.",
        "reasonBn": "শুধু মাসের নামের পূর্বে 'on' নয়, 'in' বসবে।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "টেবিলের ওপর একটি বই আছে।",
        "note": "Surface -> on"
      },
      {
        "en": "He lives in Dhaka.",
        "bn": "সে ঢাকায় বাস করে।",
        "note": "Big city -> in"
      },
      {
        "en": "Someone is standing at the door.",
        "bn": "দরজায় কেউ একজন দাঁড়িয়ে আছে।",
        "note": "Specific point -> at"
      }
    ],
    "tips": "বড় স্থান (দেশ, জেলা) = In; ছোট স্থান বা নির্দিষ্ট ঠিকানা = At!",
    "commonMistakes": [
      {
        "incorrect": "He lives at Bangladesh.",
        "correct": "He lives in Bangladesh.",
        "reasonBn": "দেশের নামের পূর্বে 'in' বসে, 'at' নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      ...
      {
        "en": "The teacher distributed sweets among all the students.",
        "bn": "শিক্ষক সকল শিক্ষার্থীর মাঝে মিষ্টি বিতরণ করলেন।"
      }
    ],
    "tips": "Two = Between; Many / All = Among!",
    "commonMistakes": [
      {
        "incorrect": "Divide the cake among Roni and Jony.",
        "correct": "Divide the cake between Roni and Jony.",
        "reasonBn": "যেহেতু কেবল দুজন ব্যক্তি (Roni ও Jony), তাই 'between' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The boy jumped into the river.",
        "bn": "ছেলেটি নদীতে ঝাঁপ দিল।",
        "note": "Movement inside -> into"
      },
      {
        "en": "She walked towards the library.",
        "bn": "সে গ্রন্থাগারের দিকে হেঁটে গেল।"
      }
    ],
    "tips": "ভেতরে থাকা বোঝাতে 'in' (স্থির অবস্থা), কিন্তু বাইরে থেকে ভেতরে প্রবেশে 'into' (গতিশীল অবস্থা)!",
    "commonMistakes": [
      {
        "incorrect": "The frog jumped in the pond.",
        "correct": "The frog jumped into the pond.",
        "reasonBn": "লাফিয়ে ভেতরে প্রবেশ করা একটি গতিশীল কাজ, তাই 'into' বসবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The brave horse jumped over the fence.",
        "bn": "সাহসী ঘোড়াটি বেড়ার ওপর দিয়ে লাফ দিল।"
      },
      {
        "en": "The fan is moving above our heads.",
        "bn": "পাখাটি আমাদের মাথার ওপর ঘুরছে।"
      },
      {
        "en": "The cat is sleeping under the table.",
        "bn": "বিড়ালটি টেবিলের নিচে ঘুমাচ্ছে।"
      }
    ],
    "tips": "স্পর্শ ছাড়া ওপর দিয়ে গতিশীল হলে 'Over', স্পর্শ করে থাকলে 'On', আর অনেক উঁচুতে হলে 'Above'!",
    "commonMistakes": [
      {
        "incorrect": "The bird flew above the tree from left to right.",
        "correct": "The bird flew over the tree.",
        "reasonBn": "একপাশ থেকে ওপর দিয়ে অন্যপাশে উড়ে গেলে 'over' হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Sit beside me, my dear friend.",
        "bn": "আমার পাশে বসো, প্রিয় বন্ধু।"
      },
      {
        "en": "Besides English, she can speak French.",
        "bn": "ইংরেজি ছাড়াও সে ফরাসি ভাষায় কথা বলতে পারে।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "পাশে বসা বোঝাতে 'beside' হবে, 'besides' নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The train passed through the dark tunnel.",
        "bn": "রেলগাড়িটি অন্ধকার সুড়ঙ্গের মধ্য দিয়ে চলে গেল।"
      },
      {
        "en": "He swam across the wide river.",
        "bn": "সে প্রশস্ত নদীটি সাঁতরে পার হলো।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "সেতু বা রাস্তার ওপর দিয়ে পারাপার বোঝাতে 'across' হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "The snake was killed by the farmer with a stick.",
        "bn": "সাপটি কৃষকের দ্বারা একটি লাঠির সাহায্যে মারা হয়েছিল।"
      },
      {
        "en": "She wrote the letter with a green pen.",
        "bn": "সে একটি সবুজ কালির কলম দিয়ে চিঠিটি লিখেছিল।"
      }
    ],
    "tips": "মানুষের দ্বারা হলে 'by', আর অস্ত্র বা কলম দিয়ে হলে 'with'!",
    "commonMistakes": [
      {
        "incorrect": "He cut the apple by a knife.",
        "correct": "He cut the apple with a knife.",
        "reasonBn": "ছুরি একটি উপকরণ (instrument), তাই এর পূর্বে 'with' বসবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "I received a letter from my uncle.",
        "bn": "আমি আমার চাচার কাছ থেকে একটি চিঠি পেয়েছি।"
      },
      {
        "en": "It has been raining since morning.",
        "bn": "সকাল থেকে অবিশ্রান্ত বৃষ্টি হচ্ছে।"
      }
    ],
    "tips": "It has been raining since morning (সকাল থেকে); He worked from 9 AM to 5 PM (৯টা থেকে ৫টা)!",
    "commonMistakes": [
      {
        "incorrect": "It has been raining from morning.",
        "correct": "It has been raining since morning.",
        "reasonBn": "অতীতের নির্দিষ্ট সময় থেকে কাজ শুরু হয়ে বর্তমানে চলছে বোঝাতে 'since' বসে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "He was tired, so he went to sleep early.",
        "bn": "সে ক্লান্ত ছিল, তাই সে তাড়াতাড়ি ঘুমাতে গেল।"
      },
      {
        "en": "She wanted to play outside, yet it was raining.",
        "bn": "সে বাইরে খেলতে চেয়েছিল, তবুও বৃষ্টি হচ্ছিল।"
      }
    ],
    "tips": "F=For, A=And, N=Nor, B=But, O=Or, Y=Yet, S=So!",
    "commonMistakes": [
      {
        "incorrect": "He was hungry because he ate food.",
        "correct": "He was hungry, so he ate food.",
        "reasonBn": "'So' ফলাফল প্রকাশ করে, আর 'because' কারণ প্রকাশ করে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "First, wash your hands with soap. Next, peel the potatoes. Finally, cook with spices.",
        "bn": "প্রথমে সাবান দিয়ে হাত ধুয়ে নাও। এরপর আলুর খোসা ছাড়াও। সবশেষে মশলা দিয়ে রান্না করো।"
      },
      {
        "en": "First we reached the station, then the train arrived.",
        "bn": "প্রথমে আমরা স্টেশনে পৌঁছালাম, তারপর ট্রেনটি এল।"
      }
    ],
    "tips": "অনুচ্ছেদ বা গল্প লেখার সময় এই শব্দগুলোর পর সাধারণত কমা (,) বসে!",
    "commonMistakes": [
      {
        "incorrect": "First wash hands, finally peel potatoes, next cook.",
        "correct": "First wash hands, next peel potatoes, finally cook.",
        "reasonBn": "Finally সবসময় সর্বশেষ ধাপে বসাতে হয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "He did not go to school because he was ill.",
        "bn": "সে স্কুলে যায়নি কারণ সে অসুস্থ ছিল।",
        "note": "Because introduces reason"
      },
      {
        "en": "He was ill, so he did not go to school.",
        "bn": "সে অসুস্থ ছিল, তাই সে স্কুলে যায়নি।",
        "note": "So introduces result"
      }
    ],
    "tips": "কারণ আগে থাকলে 'So' বসবে, আর কারণ পরে থাকলে 'Because' বসবে!",
    "commonMistakes": [
      {
        "incorrect": "Because he was sick, so he rested.",
        "correct": "Because he was sick, he rested / He was sick, so he rested.",
        "reasonBn": "একই বাক্যে 'Because' এবং 'So' একসাথে ব্যবহার করা ব্যাকরণগত ভুল।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "If you study regularly, you will do well in the exam.",
        "bn": "যদি তুমি নিয়মিত পড়াশোনা করো, তবে পরীক্ষায় ভালো করবে।"
      },
      {
        "en": "If it rains tomorrow, we will stay at home.",
        "bn": "যদি আগামীকাল বৃষ্টি হয়, তবে আমরা বাড়িতেই থাকব।"
      }
    ],
    "tips": "If-যুক্ত অংশে কখনো 'will' বসে না (If it will rain ভুল -> If it rains সঠিক)!",
    "commonMistakes": [
      {
        "incorrect": "If you will work hard, you will succeed.",
        "correct": "If you work hard, you will succeed.",
        "reasonBn": "If-এর শর্তযুক্ত ক্লজে 'will' হয় না, Present simple (work hard) হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Happy -> Unhappy / Kind -> Unkind / Lock -> Unlock",
        "bn": "সুখী -> অসুখী / দয়ালু -> নির্দয় / তালা দেওয়া -> তালা খোলা"
      },
      {
        "en": "Obey -> Disobey / Honest -> Dishonest / Agree -> Disagree",
        "bn": "মান্য করা -> অমান্য করা / সৎ -> অসৎ / একমত -> দ্বিমত"
      }
    ],
    "tips": "নতুন শব্দ শেখার দারুণ উপায়: শুধু un- বা dis- বসিয়ে শব্দের বিপরীত রূপ তৈরি করা!",
    "commonMistakes": [
      {
        "incorrect": "unhonest person.",
        "correct": "dishonest person.",
        "reasonBn": "Honest-এর বিপরীত হলো 'dishonest', unhonest নয়।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Careful (সতর্ক) <-> Careless (অসতর্ক)",
        "bn": "Be careful when crossing the busy road."
      },
      {
        "en": "Hopeful (আশাবাদী) <-> Hopeless (হতাশ)",
        "bn": "Never lose heart; do not be hopeless."
      }
    ],
    "tips": "Careful, Painful, Useful, Joyful-এ সবসময় একটি 'l' (ফুল নয়, -ful) দিয়ে শেষ হয়!",
    "commonMistakes": [
      {
        "incorrect": "carefull boy.",
        "correct": "careful boy.",
        "reasonBn": "প্রত্যয় হিসেবে বসলে '-ful'-এ একটি মাত্র 'l' হবে।"
      }
    ],
    "source": "curriculum"
  },
  {
    ...
    "examples": [
      {
        "en": "Quiet -> The children listened quietly.",
        "bn": "শান্ত -> বাচ্চারা শান্তভাবে শুনল।"
      },
      {
        "en": "Sweet -> The nightingale sang sweetly.",
        "bn": "মিষ্টি -> বুলবুলি মিষ্টি সুরে গান গাইল।"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "Fast নিজেই Adverb, 'fastly' ভুল।"
      }
    ],
    "source": "curriculum"
  },
    ...
    "examples": [
      {
        ...
        "bn": "শিক্ষার্থীটি একটি বই পড়ছে।",
        "note": "Singular: student -> is"
      },
      {
        "en": "The students are reading books.",
        "bn": "শিক্ষার্থীরা বই পড়ছে।",
        "note": "Plural: students -> are"
      }
    ],
    ...
    "commonMistakes": [
      {
        ...
        "reasonBn": "মূল Subject হলো 'One' (একবচন), বন্ধুদের মধ্যে কেবল একজন, তাই 'is' বসবে।"
      }
    ],
    "source": "curriculum"
  }
